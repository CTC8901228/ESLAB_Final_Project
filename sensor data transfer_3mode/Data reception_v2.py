        ...
        while(1):
            ...
            with conn:
                ...
                while True:
                    ...
                    Accdatalisty.append(arr[3])
                    Accdatalistz.append(arr[4])
                    Magdatalistx.append(arr[5])
                    Magdatalisty.append(arr[6])
                    Magdatalistz.append(arr[7])
                    GYROdatalistx.append(arr[8])
                    GYROdatalisty.append(arr[9])
                    GYROdatalistz.append(arr[10])
                    plt.ion()
                    # plt.subplots()
                    plt.clf()
