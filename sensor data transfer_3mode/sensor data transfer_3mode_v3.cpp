            ...
            while (1) {
                if (button_switch == 1) { 
                    ...
                    while(button_switch == 1) {
                        ...
                        sprintf(data,"%d %d %d %d %d %d %d %d %d %d %d",((int)(button_switch*10000))/10000,
                                                                    ((int)(ButtonTimer.read_ms()*10000))/10000, 
                                                                    ((int)(pACCDataXYZ[0]*10000))/10000,
                                                                    ((int)(pACCDataXYZ[1]*10000))/10000, 
                                                                    ((int)(pACCDataXYZ[2]*10000))/10000,
                                                                    ((int)(pMAGDataXYZ[0]*10000))/10000,
                                                                    ((int)(pMAGDataXYZ[1]*10000))/10000, 
                                                                    ((int)(pMAGDataXYZ[2]*10000))/10000,
                                                                    ((int)(pGyroDataXYZ[0]*10000))/10000,
                                                                    ((int)(pGyroDataXYZ[1]*10000))/10000, 
                                                                    ((int)(pGyroDataXYZ[2]*10000))/10000);
                        nsapi_size_t bytes_to_send = strlen(data);
                        nsapi_size_or_error_t bytes_sent = 0;
